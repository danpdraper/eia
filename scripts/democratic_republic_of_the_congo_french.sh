...
function amend_typos_in_articles {
  ...
  echo "$stdin" | \
    ...
    sed -E 's/Etat/État/g' | \
    # Article 2
    amend_typo_in_article 2 entrainer entraîner | \
    amend_typo_in_article 2 'les micro- organismes' 'les micro-organismes' | \
    amend_typo_in_article 2 'présente isolement' 'présente isolément' | \
    # Article 11
    amend_typo_in_article 11 'moment ne' 'moment, ne' | \
    # Article 14
    amend_typo_in_article 14 ' CHAPITRE 2:' '\n\nCHAPITRE 2 -' | \
    # Article 23
    amend_typo_in_article 23 1er 1 | \
    # Article 31
    amend_typo_in_article 31 ' Article 32' '\n\n(32)' | \
    # Article 33
    amend_typo_in_article 33 '1er ' 1 | \
    # Article 43
    amend_typo_in_article 42 ' Article 43' '\n\n(43)' | \
    # Article 61
    amend_typo_in_article 61 ' Article 62' '\n\n(62)' | \
    amend_typo_in_article 61 ' Section 5:' '\n\nSection 5 -' | \
    # Article 67
    amend_typo_in_article 67 1er 1 | \
    # Article 79
    amend_typo_in_article 79 ' Article 80' '.\n\n(80)' | \
    # Article 84
    amend_typo_in_article 84 1er 1 | \
    # Article 89
    amend_typo_in_article 89 ' Fait à Kisangani.*$' ''
}
