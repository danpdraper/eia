...
#/Users/matthkli/projects/eia/scripts/legislation/preprocess_legislation.sh namibia english && cat /Users/matthkli/projects/eia/raw_data/preprocessed/africa/namibia_english.txt