...
class TestArgumentParser(object):
    ...
    def test_parse_graph_extracts_expected_arguments(self):
        arguments = [
            '--legislation_directory_path',
            '/path/to/legislation/directory',
            '--debug',
        ...
        expected_namespace = {
            # The equality holds in the following case because the object is a
            # singleton.
            'statistic': statistics.EIGHTIETH_PERCENTILE,
            'matrix_file_path': '/path/to/matrix',
            'output_directory_path': '/path/to/output/directory',
            'legislation_directory_path': '/path/to/legislation/directory',
            'debug': True,
            'func': self.graph_function,
        }
        actual_namespace = vars(self.parser.parse(arguments))
        assert expected_namespace == actual_namespace

    def test_parse_graph_assigns_appropriate_function_to_argument_namespace(self):
        arguments = [
            '--legislation_directory_path',
            '/path/to/legislation/directory',
            '--debug',
        ...
        expected_function_output = 'graph', {
            # The equality holds in the following case because the object is a
            # singleton.
            'statistic': statistics.EIGHTIETH_PERCENTILE,
            'matrix_file_path': '/path/to/matrix',
    ...
    def test_parse_graph_raises_system_exit_when_unsupported_statistic_argument_provided(self):
        arguments = [
            '--legislation_directory_path',
            '/path/to/legislation/directory',
            '--debug',
    ...
    def test_parse_graph_does_not_raise_system_exit_when_optional_arguments_not_provided(self):
        arguments = [
            'graph',
            'eightieth_percentile',
            '/path/to/matrix',
    ...
    def test_parse_graph_assigns_false_to_debug_parameter_when_debug_argument_not_provided(self):
        arguments = [
            'graph',
            'eightieth_percentile',
            '/path/to/matrix',
    ...
    def test_parse_graph_assigns_package_path_to_legislation_directory_path_when_argument_not_provided(self):
        arguments = [
            'graph',
            'eightieth_percentile',
            '/path/to/matrix',
